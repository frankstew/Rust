...
fn main() {
    ...
    //
    //todo: maybe adjacency list is better???? I know a lot about petgraph but its kinda limited
    //and not useful for me... except fro printing but thats it... were gonna do adjacency list
