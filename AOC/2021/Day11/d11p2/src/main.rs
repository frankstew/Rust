...
//find first step where all octos flash at the same time
...
// get total flashed after n steps
...
//increment energy of all octos by 1
...
// recursively flash octos with energy > 9
...
// set all flashed octso to 0 energy
